...
import {
  ...
  AddOracleTransactionPayload,
} from "../addOracleTransaction";
...
describe("addOracleTransaction", () => {
  describe("logic", () => {
    it("should add an oracle transaction to the state", () => {
      ...
      const transactionPayload: AddOracleTransactionPayload = {
        chainId,
        from: MOCK_ADDRESS_1,
      ...
      const result = addOracleTransaction(
        transactionsState,
        transactionPayload
      );
    ...
    it("should throw an error if the transaction already exists", () => {
      ...
      expect(() => {
        addOracleTransaction(transactionsState, transactionPayload);
