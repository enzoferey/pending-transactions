...
describe("matchIsOracleTransactionConfirmed", () => {
  it("should return true if the transaction has an oracle receipt and an oracle confirmed time", () => {
  ...
  it("should return false if the transaction does not have an oracle receipt or an oracle confirmed time", () => {
    const chainId = MOCK_CHAIN_ID_1;
